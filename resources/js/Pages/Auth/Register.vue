...
<template>
    ...
    <AuthenticationCard>
        <template #logo>
            <h2 class="pr-12 md:pr-0 lg:pt-4 py-4 lg:py-8 leading-8 lg:leading-8 font-bold text-transparent text-4xl lg:text-6xl bg-clip-text bg-gradient-to-r from-purple-600 to-pink-800">
                Enter the Halls
            </h2>
        </template>
        ...
        >
            Sign Up using
            <span class="rounded-full bg-gray-500 h-8 w-8 ml-3">
